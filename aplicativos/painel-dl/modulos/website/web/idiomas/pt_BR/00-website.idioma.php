...
// Modelos ---------------------------------------------------------------------------------------------------------- //
define('TXT_MODELO_SOBRE', 'informações institucionais');
...
define('TXT_LISTA_TITULO_CAPA', 'Capa');
define('TXT_LISTA_TITULO_ICONE', 'Ícone');
...
define('TXT_ROTULO_P12', 'Arquivo do OAuth');
...
define('TXT_DICA_TIPODADO_MASCARA', 'Definir uma máscara para o preenchimento do regitro.<br/>'
	. '<b>Ex.:</b> Telefone - (##) ####-####<br/>'
...
define('TXT_DICA_P12', 'Arquivo de autenticação do <b>OAuth 2.0</b> no formato <b>.p12</b>.');
define('TXT_DICA_WEBSITE_CONFIGURACAO_EMAIL', 'Configuração de e-mail utilizada pelo website para envio de e-mails.');
...
// Diversos --------------------------------------------------------------------------------------------------------- //
define('TXT_DIVERSOS_CONTATO_DT_ENVIO', 'Contato enviado em %s');
define('TXT_DIVERSOS_EMAIL_ENVIADO', 'E-mail enviado');
define('TXT_DIVERSOS_EMAIL_FALHOU', 'O envio do e-mail falhou');
...
define('ERRO_FOTOALBUM_UPLOAD_DIRETORIO_NAO_LOCALIZADO', 'Erro! O diretório para upload das fotos (<b>%s</b>) não foi localizado e o sistema não conseguiu criá-lo.<br/>Por favor, verifique as permissões do diretório de uploads.');

# -> WebM\DadoContato
# ->-> Erros
define('ERRO_DADOCONTATO_SALVAR_REGISTRO_JA_EXISTE', 'Esse dado para contato já existe!<br/>Por favor, cadastre um novo dado para contato.');