...
class Modulo extends GeralC\PainelDL{
    ...
    protected function mostrarLista(){
        $this->listaPadrao('M.modulo_id AS '. TXT_LISTA_TITULO_ID .", CONCAT(M.modulo_nome, '<br/>', COALESCE(S.modulo_nome, '')) AS " . TXT_LISTA_TITULO_NOME . ','
    ...
    protected function criarFuncionalidadesPadrao($pk){
        ...
        $retorno = [
            0 => ['mensagem' => ERRO_MODULO_CRIARFUNCIONALIDADESPADRAO, 'tipo' => '__msg-erro'],
            1 => ['mensagem' => SUCESSO_MODULO_CRIARFUNCIONALIDADESPADRAO, 'tipo' => '__msg-sucesso']
        ];
    ...
    protected function salvar(){
        ...
        \Funcoes::mostrarMsg(sprintf(SUCESSO_PADRAO_REGISTRO_SALVO, $this->nome), '__msg-sucesso');
