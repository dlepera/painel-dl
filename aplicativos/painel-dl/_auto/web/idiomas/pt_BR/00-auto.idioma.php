...
define('TXT_LINK_ALTERAR_MINHA_SENHA', 'Alterar a minha senha');
define('TXT_LINK_LOGOUT', 'Sair do sistema');
define('TXT_LINK_EDITAR', 'Editar');
define('TXT_LINK_REMOVER', 'Remover');
define('TXT_LINK_LIMPAR_FILTRO', 'Limpar filtro');
...
define('TXT_LINK_TITLE_REMOVER', 'Remover esse registro');
define('TXT_LINK_TITLE_REMOVER_SELECIONADOS', 'Remover registros selecionados');
define('TXT_LINK_TITLE_DETALHES', 'Exibir os detalhes');
define('TXT_LINK_TITLE_BLOQUEAR_USUARIO', 'Bloquear esse usuário');
...
define('TXT_ROTULO_SENHA_NOVA_CONF', 'Confirme a nova senha');
...
define('TXT_DIVERSOS_CONFIRMAR_ALTERAR_SENHA', 'Você está prestes a alterar a sua senha. Não será possível desfazer essa ação!<br/><br/>Deseja realmente continuar?');
